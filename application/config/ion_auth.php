...
*/
$config['tables']['users']           = 'akun';
$config['tables']['groups']          = 'tingkatan';
$config['tables']['users_groups']    = 'detail_tingkatan';
$config['tables']['login_attempts']  = 'percobaan_login';
 ...
 */
$config['join']['users']  = 'id_akun';
$config['join']['groups'] = 'id_tingkatan';
 ...
 */
$config['site_title']                 = "e-kelurahan.dev";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'operator';           // Default group, use name
$config['admin_group']                = 'Admin Kecamatan';             // Default administrators group, use name
