		...
		<div class="panel">
			<div class="panel-heading">
				...
				<div class="btn-group pull-right">
					<button class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-tambah"><i class="fa fa-upload"></i> Unggah Video</button>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4">
                                <a href="#" onclick="show('{{ $list->link }}')">
                                    <figure>
                                        ...
                                        <figcaption style="text-align: center">{{ !empty($list->nama) ? $list->nama : 'Video ' . $i }}</figcaption>
                                    </figure>
                                </a>
                            </div>
                            <?php $i--; ?>
