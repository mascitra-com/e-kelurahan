...
<div class="panel panel-theme">
	<div class="panel-heading">
		...
		<div class="btn-group pull-right">
			...
			<!-- SAMPAI SINI -->
			<a href="kelahiran/tambah" class="btn btn-default btn-sm"><i class="fa fa-plus"></i></a>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<button class="btn btn-block btn-success btn-xs btn-ambil" title="telah diambil" data-toggle="modal" data-target="#modal-ambil" data-id_surat={{ $kelahiran->id }}><i class="fa fa-check"></i></button>	
