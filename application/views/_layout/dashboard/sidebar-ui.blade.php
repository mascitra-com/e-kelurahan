<div id="sidebar">
	<div id="sidebar-wrapper">
		...
		<ul class="sidebar-nav">
			...
			<li><a href="{{site_url('ui/kependudukan')}}"><i class="fa fa-fw fa-user"></i><span class="nav-label">Kependudukan</span></a></li>
			<li><a href="{{site_url('ui/keluarga')}}"><i class="fa fa-fw fa-users"></i><span class="nav-label">Keluarga</span></a></li>
			<li>
