...
<div class="panel panel-theme">
	<div class="panel-heading">
		<h3 class="panel-title pull-left">Surat Keterangan Miskin</h3>
		<div class="btn-group pull-right">
			...
			<a href="{{ site_url('surat/arsip/keterangan_miskin') }}" class="btn btn-default btn-sm"><i class="fa fa-archive"></i></a>
		</div>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ site_url('surat/simpan/2') }}" method="POST">
					{{ $csrf }}
			...
			<div class="modal-body table-responsive table-full">
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						@if($miskin->status == '0')
						<tr>
							<td class="text-center">{{ $miskin->id }}</td>
							<td class="text-center">{{ $miskin->nik }}</td>
