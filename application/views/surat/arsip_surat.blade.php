...
@section('title')Arsip surat Isian KTP@endsection
@section('nama-kelurahan')Lumajang@endsection

@section('content')
<div class="panel panel-theme">
	<div class="panel-heading">
		<h3 class="panel-title pull-left">surat Isian KTP</h3>
		...
		<table class="table table-stripped table-hover table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{ site_url('surat/kembalikan/'. $surat->jenis .'/'.$surat->id) }}" class="btn btn-default btn-xs" onclick="return confirm('Anda yakin?')"><i class="fa fa-upload"></i> kembalikan</a>
						<a href="{{ site_url('surat/hapus/'. $surat->jenis .'/'.$surat->id) }}" class="btn btn-default btn-xs" onclick="return confirm('Data anda akan benar-benar hilang. Anda yakin?')"><i class="fa fa-trash"></i> hapus</a>
					</td>
				</tr>
				@endforeach
			</tbody>
