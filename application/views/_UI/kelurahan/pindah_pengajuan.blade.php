							...
							<div class="row">
								<div class="col-xs-12">
									<div class="row">
										<div class="col-xs-12 col-md-6">
											<div class="form-group">
												<label class="text-size-14">1. Alamat Asal Lengkap</label>
									...
									<div class="row">
										...
										<div class="col-xs-12 col-md-6">
											<div class="form-group">
												<label for="">4. Kabupaten / Kota</label>
									...
									<div class="row">
										...
										<div class="col-xs-12 col-md-6">
											<div class="form-group">
												<label for="">6. Kelurahan/Desa</label>
												<select name="kabupaten" class="form-control">
