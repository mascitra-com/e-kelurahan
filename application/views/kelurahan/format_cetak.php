								...
								<table class="table table-bordered">
									...
									<!-- foreach ($cetak->mutasi_keluar_details as $pengikut) { -->
									    <tr>
									    	<td><?= ++$j ?></td>
									    	<td>
									    		<!-- <?= $pengikut->penduduk->nama ?> -->
									    	</td>
									    	<td>
									    		<!-- <?php if($pengikut->penduduk->jenis_kelamin === '0'){
									    			echo '&#10004;';
									    		} else{
									    			echo '-';
									    		}
									    	...
									    	<td>
									    		<!-- <?php if($pengikut->penduduk->jenis_kelamin === '1'){
									    			echo '&#10004;';
									    		} else{
									    			echo '-';
									    		}
									    	...
									    	<td>
									    		<!-- <?= date('Y') - date('Y', strtotime($pengikut->penduduk->tanggal_lahir)) ?> -->
									    	</td>
									    	<td>
									    	<!-- <?php
