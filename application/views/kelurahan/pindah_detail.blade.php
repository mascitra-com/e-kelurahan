					...
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="nomor_surat" placeholder="Nomor Surat" value="{{ $mutasi->no_surat }}">
						...
						<div class="col-xs-12 col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nik" placeholder="NIK - Nama Lengkap" value="{{ $mutasi->nik . ' | ' . $mutasi->penduduk->nama }}">
							</div>
						</div>
					</div>
					<div class="row">
