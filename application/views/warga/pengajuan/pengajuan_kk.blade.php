...
@section('title')Pengajuan Surat Blanko KK@endsection
	...
	<div class="col-xs-12 col-sm-6">
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">Pengajuan Surat Blanko KK</h3>
			</div>
			<div class="panel-body">
				...
				<form action="{{ site_url('warga/pengajuan/blankokk_simpan') }}" method="POST">
					{{ $csrf }}
