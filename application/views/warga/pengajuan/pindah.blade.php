...
@section('title')Pengajuan Surat Pindah@endsection
	...
	<div class="col-xs-12">
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">Pengajuan Pindah</h3>
			</div>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form action="{{ site_url('warga/pengajuan/pindah_simpan') }}" method="POST">
									{{ $csrf }}
...
<script>
	...
	function handleDatalist() {
		...
		console.log(nik);
		$.getJSON('{{ site_url() }}'+'warga/pengajuan/ambil_nama_nik', function (result) {
			if (result) {
...
function getDataWarga(nik) {
	...
	$.getJSON("{{ site_url('warga/pengajuan/ambil_penduduk/') }}"+nik_s, function (result) {
		if (result) {
			for (var i = 0; i < result.length; i++) {
				var penduduk= result[i];
