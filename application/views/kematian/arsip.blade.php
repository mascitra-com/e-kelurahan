...
@section('title')Arsip kelahiran keterangan kelahiran@endsection
		...
		<table class="table table-stripped table-hover table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{ site_url('kelahiran/kembalikan/'.$kelahiran->id) }}" class="btn btn-default btn-xs" onclick="return confirm('Anda yakin?')"><i class="fa fa-upload"></i> kembalikan</a>
						<a href="{{ site_url('kelahiran/hapus/'.$kelahiran->id) }}" class="btn btn-default btn-xs" onclick="return confirm('Data anda akan benar-benar hilang. Anda yakin?')"><i class="fa fa-trash"></i> hapus</a>
					</td>
				</tr>
				@endforeach
			</tbody>
				...
				<form action="#">
					<div class="row">
						<div class="col-xs-12- col-md-6">
							<div class="form-group">
								<label for="">Nomor kelahiran</label>
								<input type="text" class="form-control" name="no_kelahiran" placeholder="nomor kelahiran" />
							</div>
						</div>
						<div class="col-xs-12- col-md-6">
							<div class="form-group">
					...
					<div class="form-group">
						...
						<select name="order" class="form-control">
							<option value="0">Nomor kelahiran ASC</option>
							<option value="1">Nomor kelahiran DESC</option>
